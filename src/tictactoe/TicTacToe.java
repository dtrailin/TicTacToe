                ...
                while (AIwork == true) {
                    for (int x = 0; x <= 6; x += 2) {
                        if (Grid[x + 1] == Grid[x + 2] && Grid[x + 2] == 2 && Grid[x + 3] == 0) {
                            ...
                            Grid[x + 1] = 2;
                            AIwork = false;
                        } else if (Grid[x + 1] == Grid[x + 3] && Grid[x + 3] == 2 && Grid[x + 2] == 0) {
                            Grid[x + 2] = 2;
                            AIwork = false;
                        }
                        for (int l = 0; l < 3; l++) {
                            if (Grid[l + 1] == Grid[l + 4] && Grid[l + 4] == 2 && Grid[l + 7] == 0) {
                                Grid[l + 7] = 2;
                                AIwork = false;
                            } else if (Grid[l + 4] == Grid[l + 7] && Grid[l + 4] == 2 && Grid[l + 1] == 0) {
                                Grid[l + 1] = 2;
                                AIwork = false;
                            } else if (Grid[l + 1] == Grid[l + 7] && Grid[l + 1] == 2 && Grid[l + 4] == 0) {
                                Grid[l + 4] = 2;
                                AIwork = false;
                            }
                        }
                        if (Grid[1] == Grid[5] && Grid[5] == 2 && Grid[9] == 0) {
                            Grid[9] = 2;
                            AIwork = false;
                        } else if (Grid[5] == Grid[9] && Grid[5] == 2 && Grid[1] == 0) {
                            Grid[1] = 2;
                            AIwork = false;
                        } else if (Grid[1] == Grid[9] && Grid[9] == 2 && Grid[5] == 0) {
                            Grid[5] = 2;
                            AIwork = false;
                        } else if (Grid[3] == Grid[5] && Grid[5] == 2 && Grid[7] == 0) {
                            Grid[7] = 2;
                            AIwork = false;
                        } else if (Grid[3] == Grid[7] && Grid[3] == 2 && Grid[5] == 0) {
                            Grid[5] = 2;
                            AIwork = false;
                        } else if (Grid[5] == Grid[7] && Grid[5] == 2 && Grid[3] == 0) {
                            Grid[3] = 2;
                            AIwork = false;
                        }
                    }
